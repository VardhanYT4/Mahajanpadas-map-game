const DATA=[
["kamboja","Kamboja","Far northwest — think beyond Gandhara.","The far northwestern region of the ancient subcontinent.","🧭",10.6,10.4],
["gandhara","Gandhara","Northwest — think Taxila.","The northwest, around the Taxila region.","🏛️",24.1,13.2],
["kuru","Kuru","Around the Delhi–Haryana region.","North-central India, around the upper Yamuna and Delhi-Haryana region.","👑",38.1,32.2],
["panchala","Panchala","East of Kuru.","East of Kuru in the upper Ganga-Yamuna region.","🌾",47.5,36.2],
["matsya","Matsya","Southwest of Surasena.","Around parts of present-day Rajasthan.","🐟",38.3,46.4],
["surasena","Surasena","Think Mathura.","Centered around Mathura and the Yamuna.","🏹",45.0,42.5],
["kosala","Kosala","North of the Ganga, east of Panchala.","Eastern Gangetic plain, associated with Shravasti and Ayodhya.","🦁",57.3,38.7],
["malla","Malla","Near the Himalayan foothills, east of Kosala.","Eastern Gangetic region near the Himalayan foothills.","⛰️",65.0,42.8],
["vajji","Vajji","Think Vaishali, north of the Ganga.","North Bihar region, associated with Vaishali.","🤝",70.3,45.5],
["kashi","Kashi","Think Varanasi.","Centered around Varanasi on the Ganga.","🪔",61.5,47.3],
["vatsa","Vatsa","Think Kaushambi, near the Yamuna.","Centered around Kaushambi in the lower Yamuna region.","🏺",53.7,45.0],
["chedi","Chedi","Central India, east of Avanti.","Central India around the Bundelkhand region.","⚔️",50.1,52.0],
["avanti","Avanti","Western/central India — think Ujjayini.","Western/central India, associated with Ujjayini.","🐘",41.8,62.8],
["magadha","Magadha","South of the Ganga in eastern India.","South Bihar and the eastern Gangetic plain.","🏰",69.7,51.4],
["anga","Anga","Farther east of Magadha.","Farther east, around the Champa region.","🌊",77.8,56.3],
["asmaka","Asmaka","The southernmost — near the Godavari.","The southernmost traditional Mahajanapada, associated with the Godavari region.","🌴",50.1,85.6]
